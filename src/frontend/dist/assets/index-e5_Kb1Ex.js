...
const PRODUCT_IMAGE = "/assets/uploads/image-019d1fec-a40b-70eb-aa95-80c17e5769ee-1.png";
const PRICING_IMAGE = "/assets/uploads/image-019d1f5c-7f55-77ca-b12a-f6774ef4663a-1.png";
...
function App() {
  ...
  const trustBadges = [
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-8 h-8", style: { color: "#B11E2A" } }),
      label: "100% Natural Ingredients"
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-8 h-8", style: { color: "#B11E2A" } }),
      label: "Made In USA"
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-8 h-8", style: { color: "#B11E2A" } }),
      label: "GMP Certified Facility"
    },
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-8 h-8", style: { color: "#B11E2A" } }),
  ...
  const keyBenefits = [
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-6 h-6", style: { color: "#B11E2A" } }),
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { className: "w-6 h-6", style: { color: "#B11E2A" } }),
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-6 h-6", style: { color: "#B11E2A" } }),
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-6 h-6", style: { color: "#B11E2A" } }),
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { className: "w-6 h-6", style: { color: "#B11E2A" } }),
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-6 h-6", style: { color: "#B11E2A" } }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 md:order-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  style: { backgroundColor: "#B11E2A" },
                  children: "Advanced Natural Formula"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-5xl lg:text-[52px] font-bold leading-tight text-gray-900 mb-6", children: [
                "Glyco Lean™ –",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#B11E2A" }, children: "Advanced Natural Support" }),
                " ",
                "for Healthy Blood Sugar and Metabolic Balance"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-lg leading-relaxed mb-8", children: "Glyco Lean™ is a premium plant-based dietary supplement designed to support balanced blood sugar levels, healthy metabolism, and consistent daily energy. Carefully selected herbal extracts work together to support metabolic function and promote stable energy throughout the day." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-4 items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                OrderButton,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap gap-4 text-sm text-gray-600", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-1 md:order-2 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6", children: trustBadges.map((badge) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center text-center gap-3 p-4",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-red-50 flex items-center justify-center", children: badge.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-gray-800", children: badge.label })
              ]
            },
            badge.label
          )) }) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-14 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 mb-4", children: [
                "What is ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#B11E2A" }, children: "Glyco Lean™?" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed mb-6", children: "Glyco Lean™ is a plant-based dietary supplement designed to support balanced blood sugar levels and healthy metabolic function. Maintaining stable glucose levels is essential for sustained energy, mental clarity, and overall wellness." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 mb-8", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700 font-medium", children: item })
              ] }, item)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                OrderButton,
                {
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 mb-3", children: "What Customers Are Saying" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-lg", children: "Real experiences from real people" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 fill-yellow-400 text-yellow-400" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 fill-yellow-400 text-yellow-400" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 fill-yellow-400 text-yellow-400" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 fill-yellow-400 text-yellow-400" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 fill-yellow-400 text-yellow-400" })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 leading-relaxed mb-4 italic", children: [
                    '"',
                    t.text,
                    '"'
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-900", children: t.name }),
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 mb-3", children: [
                "How ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#B11E2A" }, children: "Glyco Lean" }),
                " ",
                "Supports Healthy Blood Sugar Balance"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "Glyco Lean Drops are designed to support natural blood sugar balance, metabolic health, and steady daily energy using a carefully crafted plant-based formula." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-8", children: howItWorks.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-900 mb-2", children: step.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm leading-relaxed", children: step.desc })
                  ] })
                ]
              },
              step.step
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white mb-3", children: "Limited Time Special Pricing – Act Now!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-200 text-lg", children: "Secure your supply before it runs out" })
            ] }),
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-2xl mx-auto", children: "Glyco Lean Drops are designed to help support balanced blood sugar levels and healthy metabolic function through a comprehensive, plant-based approach." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: keyBenefits.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-red-50 flex items-center justify-center mb-4 group-hover:bg-red-100 transition-colors", children: b.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-900 mb-2", children: b.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center md:items-start md:text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: { backgroundColor: "#B11E2A" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-12 h-12 mb-1" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider", children: "Risk-Free" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-extrabold", children: "60" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase", children: "Day" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-gray-900", children: "60-Day Risk-Free Satisfaction Guarantee" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 mb-4", children: [
                "Risk-Free 60-Day",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#B11E2A" }, children: "Money-Back Guarantee" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed mb-4", children: "Your satisfaction matters to us. That's why every order of Glyco Lean Drops is protected by a full 60-day money-back guarantee from the date of purchase. This allows you to try the product with complete peace of mind." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed mb-6", children: "If you are not fully satisfied for any reason, simply contact our customer support team within 60 days. We will guide you through the quick and simple return process and provide a refund according to our policy." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                OrderButton,
                {
                  label: "Order Glyco Lean Today",
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-2xl mx-auto", children: "Glyco Lean Drops feature a powerful blend of carefully selected botanical extracts, vitamins, and essential nutrients designed to support balanced blood sugar levels, healthy metabolism, and steady daily energy." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10", children: ingredients.map((ing, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-900 mb-2", children: ing.name }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 mb-3", children: "Frequently Asked Questions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "Everything you need to know about Glyco Lean™" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Accordion,
              {
                ...
                children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  AccordionItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-semibold text-gray-900 hover:no-underline py-4", children: faq.q }),
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-gray-900 mb-3", children: [
                ...
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#B11E2A" }, children: "Order Discounted Glyco Lean" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-lg", children: "Limited time offer – secure your supply today" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-center gap-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: PRODUCT_IMAGE,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 line-through text-lg mb-1", children: "Regular Price: $79 per Bottle" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-3xl font-extrabold mb-6",
                    style: { color: "#B11E2A" },
                    children: "Today Only: $49 per Bottle"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  OrderButton,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-4", children: "✓ 60-Day Money Back Guarantee  |  ✓ Free Shipping" })
              ] })
            ] })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-8 bg-gray-50 border-t border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Disclaimer:" }),
        " The information provided on this website is for general educational and informational purposes only and is not intended as medical advice. Glyco Lean™ is a natural dietary supplement designed to support overall wellness and healthy lifestyle habits. It is not intended to diagnose, treat, cure, or prevent any disease. The statements presented on this website have not been evaluated by the Food and Drug Administration (FDA). Individuals should consult a qualified healthcare professional before starting any dietary supplement, especially if pregnant, nursing, taking medication, or managing a medical condition. Individual results may vary."
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: { backgroundColor: "#B11E2A" },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { className: "w-4 h-4 text-white" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg", children: "Glyco Lean™" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "nav",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-gray-700 mt-8 pt-6 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-sm", children: [
              "© ",
              (/* @__PURE__ */ new Date()).getFullYear(),
              " Glyco Lean™. All Rights Reserved."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 text-xs mt-2", children: [
              "Built with ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-5 h-5 -rotate-90" })
      }
    )
  ] });
}
